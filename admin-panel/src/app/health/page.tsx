...
export default function HealthPage() {
  const { systemHealth, setActiveTab } = useAdminStore();
          ...
          <GlassCard title="Distributed Queue Status" hasGlow={true}>
            <div className="space-y-3.5 text-xs font-bold">
              ...
              <button
                ...
                disabled={refreshing}
                className="w-full h-10 mt-2 rounded-xl bg-[#00C2FF] text-black font-black uppercase text-[9px] tracking-[2px] flex items-center justify-center gap-1.5 active:scale-[0.98] transition-transform"
              >
...
// Sub-component inside health page
const HealthItem = ({ label, value, icon: Icon, color }: { label: string; value: string; icon: any; color: string }) => (
