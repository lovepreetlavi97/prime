      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-xs font-black text-white leading-none mt-0.5 block">{stats.totalUsers + 12}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-xs font-black text-amber-500 leading-none mt-0.5 block">142</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-xs font-black text-green-500 leading-none mt-0.5 block">{stats.activeSignals}</span>
          </div>
        </div>
      </div>
